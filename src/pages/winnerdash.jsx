...
const winnerdash = () => {
  return (
    ...
    <div style={{ display:"flex",flexWrap:"wrap",justifyContent:"center",gap:"10px",marginTop:"150px" }} >
      ...
      <Rankcard rank ="7th" name="Abin Thomaas" score="6000" image ="https://media.licdn.com/dms/image/D5603AQGElTloTUNssw/profile-displayphoto-shrink_100_100/0/1697642503577?e=1724284800&v=beta&t=8xuL37HmEwYJ7je4dBm5W7_2WPUIjvQC2wHe6lRSoJw" pos="Team member" />
